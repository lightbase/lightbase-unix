...
TEXT *numero, *senha;
{
   ...
   printf("|                                                 | \n");
   printf("|                                                 | \n");
   printf("| Os codigos abaixo sao respectivamente o  numero | \n");
   printf("|                                                 | \n");
   printf("| de serie e a chave de ativacao desta  copia  do | \n");
   printf("|                                                 | \n");
   printf("| LIGHT  BASE.  Eles  serao  necessarios  para  a | \n");
   printf("|                                                 | \n");
   printf("| primeira instalacao deste produto. Guarde estes | \n");
   printf("|                                                 | \n");
   printf("| numeros em local seguro pois eles sao  a  chave | \n");
   printf("|                                                 | \n");
   printf("| mestra de utilizacao desta copia do LIGHT BASE. | \n");
   printf("|                                                 | \n");
   printf("|                                                 | \n");
   printf("|                                                 | \n");
   printf("|     Numero de serie ... :   %s              | \n", numero);
   printf("|                                                 | \n");
   printf("|     Chave de ativacao.. : %s              | \n", senha);
   printf("|                                                 | \n");
   printf("|                                                 | \n");
   printf("*-------------------------------------------------* \n");
